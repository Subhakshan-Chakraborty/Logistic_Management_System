...
class BillClass:
    def __init__(self,root):
        ...
        #==clock==#
        self.lbl_clock = Label(self.root, text="Welcome to our Logistic Management System \t\t Date:DO-MM-YYYY \t\t Time: HH:MM:SS", font=("times new roman",15),bg="#4d636d",fg="white")
        ...
        lbl_search=Label(ProductFrame2,text="Product Name",font=("times new roman",15,"bold"),bg="white",fg="green").place(x=2,y=45)
...
#=============ALL Functions=============
    ...
    def bill_top(self):
        ...
        bill_top_temp=f''''
\t\tGroup-4-Logistics
\t phone no.:8240477096,Kol-700053
{str("="*47)}
