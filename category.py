...
class categoryClass:
    def __init__(self,root):
        ...
        cat_frame.place(x=700,y=120,width=380,height=300)
        ...
        # self.im2=Image.open("images/category2.png")
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error", "Error Please, try different", parent=self.root)
                else:
